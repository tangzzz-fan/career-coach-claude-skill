...
- **6 道闸门**：现金预警、地域/薪资扩展、双轨再平衡、内容30天、中断警报等
...
| 文档 | 用途 |
|------|------|
| `每日行动作战表.md` | 每日节奏、周指标底线、阶段清单、铁律 |
| `翻身作战图.md` | 定位标签、赛道选择、搜索关键词 |
| `野路子探索矩阵.md` | （可选）副线探索、内容策略 |
| `AI-Agent学习计划.md` | （可选）技能学习计划 |

## 自定义

### 周指标底线

在 `每日行动作战表.md` 中设定你的五个底线指标：
- 投递数 ≥ ? /周
- 回复数 ≥ ? /周
- 约面数 ≥ ? /周
- 二面数 ≥ ? /周（第3周起）
