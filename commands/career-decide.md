...
**Your task**:
1. Read relevant sections from the planning documents that bear on this decision
2. Read current funnel data from `tracking/漏斗记录表.md`
...
Important: Do NOT override any pre-committed gate triggers or iron laws. If the user wants to change a rule they set for themselves, flag it and ask them to confirm.
